...
Es una encuesta longitudinal que busca ser representativa de la **.morado[población urbana]** y sigue al mismo grupo de personas desde el 2016 hasta el 2026. Posee 7 módulos principales de los cuales nos interesa el módulo **.morado[Salud y Bienestar]**.
...
Para el año 2016 de la muestra del estudio ELSOC.

---

<h1> .morado[Patrones de intesidad en la PHQ-9] </h1>

Las metodologías No Supervisadas nos permiten identificar grupos dentro de nuestros datos.
...
A partir de **.verde[k-modas iniciales]**, se ubica la observación al cluster más cercano según la medida de **.verde[disimiltud]**. Esta función la definimos como $d_{sim}(x,y)$, la que toma dos vectores de p dimensiones y cuenta el número de componentes de distinto valor. 
...
Escogemos **tres** clusters como el número óptimo.
---
...
Para el año 2016 de la muestra ELSOC (de un total de 2888 observaciones)
---
