...
---
<h1> .azul[Sospecha EDM según cluster] </h1>

<iframe src="GRAFICOS/sospecha_edm_por_cluster.html" width="100%" height="400" id="igraph" scrolling="no" seamless="seamless" frameBorder="0"> </iframe>

.center[Puntajes de la escala PHQ-9 mayores o iguales a 10 sirven para identificar **.azul[sospecha de un episodio depresivo mayor]**]
---
...
* No hay buena literatura sobre el **.azul[desempeño]** del algortimo **.azul[K-Modes]**.
...
* Puede ser un primer paso para ocupar modelos de **.morado[transición]** en el tiempo de una categoría a otra.
